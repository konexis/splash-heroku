...
CMD python3 /app/bin/splash --proxy-profiles-path /etc/splash/proxy-profiles --js-profiles-path /etc/splash/js-profiles --lua-package-path /etc/splash/lua_modules/?.lua --port $PORT
